.. -*- mode: rst -*-
==========================================
 Keyboards for the Faroese language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Faroese language. The data and implementations
...
* http://divvun.no/doc/tools/docu-fao-manual.html
...
The Faroese keyboard sources can be acquired using the `Giella SVN
